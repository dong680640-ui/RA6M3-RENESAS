...
/* Actual period: 5 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xa000,
  .duty_cycle_counts = 0x5000, .source_div = (timer_source_div_t) 2, .channel = 0, .p_callback = R_AGT0_Interrupt,
